...
<template>
  <div class="space-y-6">
    ...
    <p class="text-gray-600 dark:text-gray-300 text-sm leading-relaxed mb-6">
      Sampaikan pendapat, pengaduan, atau aspirasi Anda langsung kepada pimpinan
      pondok. Seluruh data identitas pelapor akan dijaga kerahasiaannya.
    </p>
    ...
    >
      ...
      <p class="text-sm mt-1">
        Terima kasih atas kepedulian Anda. Aspirasi ini akan kami sampaikan ke
        pihak terkait.
      </p>
    </div>
    ...
    <form v-else class="space-y-5" @submit.prevent="form.handleSubmit()">
      ...
      <FormFile name="attachment" label="Lampiran Foto/Bukti (Opsional)" />
