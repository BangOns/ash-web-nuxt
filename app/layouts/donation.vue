    ...
    <NuxtLayout name="default">
        ...
        >
            ...
            >
                ...
                <div
                    class="container mx-auto px-6 lg:px-12 relative z-10 text-center max-w-4xl space-y-4"
                >
                    <motion.h1
                        :initial="{ opacity: 0, y: 30 }"
                        :animate="{ opacity: 1, y: 0 }"
                        class="text-4xl md:text-5xl font-extrabold tracking-wide uppercase font-sans"
                    >
                        Donasi & Sedekah
                    </motion.h1>
                    <motion.p
                        ...
                        class="text-[#B5E9D5] text-base md:text-lg max-w-2xl mx-auto leading-relaxed font-sans"
                    >
                        Salurkan bantuan terbaik Anda untuk pembangunan sarana pendidikan dan asrama santri Pondok Pesantren Ashhaburratib.
                    </motion.p>
                </div>
                <!-- Wave Gelombang -->
                <div
            ...
            <!-- Content Slot -->
            <section class="container mx-auto px-6 lg:px-12 mt-12 relative z-30">
                <slot />
            </section>
        </article>
    </NuxtLayout>
